...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 04 mai 2022 à 09:15
...
(76, 'Les fans peuvent agrandir leur univers LEGO Super Mario avec les Packs surprise de personnages.', 'Super Mario Pack Personnage Series 1', 59, '71361', 43),
(77, NULL, 'Ensemble d\'Extension La chasse au trésor de Toad', 63, '71368', 43),
(78, NULL, 'La bataille du château de Bowser', 89, '71369', 43),
(79, NULL, 'La forteresse de la Plante Piranha', 44, '71362', 43),
(80, NULL, 'Costume Mario de feu', 9, '71370', 43),
(81, NULL, 'Costume de Mario chat', 9, '71372', 43),
(82, NULL, 'La forteresse de lave de Whomp', 18, '71364', 43),
(83, NULL, 'Ensemble d\'extension Désert', 18, '71363', 43),
(84, NULL, 'Costume de Mario hélice', 10, '71371', 43),
(85, NULL, 'Costume de Mario Grenouille', 8, '71392', 43),
(86, NULL, 'Costume de Mario Abeille', 8, '71393', 43),
(87, NULL, 'Le Marais empoisonné de Wiggler', 37, '71383', 43),
(88, NULL, 'La Rencontre de Chomp dans la Jungle Set d\'extension avec Figurine de Bramball', 30, '71381', 43),
(89, NULL, 'Le défi de la Plante Piranha', 28, '71382', 43),
(90, 'Initiez les enfants à l’univers interactif LEGO Super Mario avec le Pack de Démarrage Les Aventures de Luigi (71387). Le personnage LEGO Luigi inclus réagit instantanément via un écran LCD et un haut-parleur. Les joueurs gagnent des pièces numériques en aidant LEGO Luigi à relever des défis de vol et de balançoire pivotante, à interagir avec Yoshi rose, ou à vaincre Boum Boum et un Goomb’os. Les briques marron de ce biome Tour déclenchent différentes réactions chez LEGO Luigi et la brique d’action ? fait gagner des bonus supplémentaires.', 'Pack de démarrage Super Mario : Les Aventures de Luigi', 45, '71387', 43),
(91, 'Pour commencer, les fans peuvent découvrir l’univers amusant de LEGO Super Mario avec ce Pack de démarrage Les Aventures de Mario (71360), comprenant 7 briques d’action pour interagir de différentes façons avec le personnage LEGO Mario.\r\nLEGO Mario est doté d\'un capteur de couleur et d’écrans LCD dans les yeux, la bouche et le ventre, qui lui permettent de réagir au mouvement en affichant instantanément de nombreuses réactions Il intègre également un haut-parleur qui émet des sons et des musiques emblématiques du jeu vidéo\r\nDans ce formidable set de jeu, LEGO Mario collecte des pièces virtuelles en courant et en sautant du tuyau de départ jusqu’au poteau d’arrivée ; pour cela, il doit franchir des briques LEGO, des plateformes nuages ou encore la brique d\'action ?, et affronter le Goomba et Bowser Jr', 'Pack de démarrage Super Mario : Les Aventures de Mario', 60, '71360', 43),
(92, NULL, 'Désert de Pokey', 20, '71363', 43),
(93, NULL, 'La balance de la Plante Piranha', 20, '71365', 43),
(94, NULL, 'Barrage de Bill Bourrins', 30, '71366', 43),
(95, NULL, 'La maison de Mario et Yoshi', 30, '71367', 43);
...
(37, 'Lego Super Mario', 'Dérivés de Super Mario');
